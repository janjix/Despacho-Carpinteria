...
import { LOGO_PDF, LOGO_PROPORCION } from './logo'
...
function encabezado(doc, proyecto, titulo) {
  ...
  // Logo de FATE: 26 mm de ancho, alto según su proporción
  const anchoLogo = 26
  doc.addImage(LOGO_PDF, 'PNG', MARGEN, MARGEN + 2.5,
    anchoLogo, anchoLogo / LOGO_PROPORCION, undefined, 'FAST')
...
function pieDePagina(doc) {
  ...
  for (let i = 1; i <= paginas; i++) {
    ...
    doc.text('FATE Despacho', MARGEN, alto - 8)
  }
}
