...
import { ESTADOS, ORDEN_ESTADO, abreviar, esHoy, fechaCorta, hora, resumir } from '../lib/codigos'
...
function FilaGrupo({ grupo, viajes, onImprimir, onEditar, onBorrar, onCambiarEstado }) {
