  ...
  return (
    ...
    >
      <div className="space-y-5">
          ...
          <div className="border border-tinta p-4 space-y-3">
            ...
            {(() => {
              ...
              return (
                <>
                  {r.renglones
                    ? <RevisionLista filas={leidas} onCambiar={(nuevas) => {
                        const limpias = filas.filter(f => f.nombre.trim())
                        setFilas([...limpias, ...nuevas])
                        setPegado(null)
                      }} />
        ...
        {validas.length > 0 && (
          <RevisionLista filas={validas} onCambiar={setFilas} />
        )}
        ...
        <div className="flex flex-wrap items-center justify-between gap-3 pt-1">
          <p className="text-[14px] text-tenue">
            Se generarán <strong className="text-tinta">{totalEtiquetas}</strong> etiquetas
          </p>
