...
export default function ZonaProyecto({
  ...
  return (
    <section className="flex flex-col min-h-0 min-w-0 h-full">
      ...
      {/* Este es el contenedor que se mide. La sección de arriba necesita
          h-full: sin altura definida, este flex-1 no tiene de dónde crecer y
          mide su propio contenido en lugar del espacio libre. Eso daba
          capacidad para una tarjeta y decenas de páginas con la pantalla
          medio vacía. */}
