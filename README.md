...
- **Varios proyectos a la vez.** En *Ajustes → Proyecto* está la opción *Todos
  los proyectos activos*, para cuando se embalan dos obras en paralelo y hay un
  solo televisor. Ahí cada tarjeta antepone el nombre del proyecto al del área.
...
- **Sin scroll, y sin filas cortadas.** El panel mide el espacio real de la
  ...
  cortaba: cuántas entran depende del tamaño de letra, la orientación y la
  pantalla concreta, no de lo que uno haya elegido en el menú. En *Ajustes →
  Tarjetas por pantalla* la opción **Auto** es la predeterminada y dice cuántas
  caben; los números fijos siguen ahí, con la advertencia de que pueden
  cortarse.
