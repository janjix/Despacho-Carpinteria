...
**Controles**, ocultos hasta que se mueve el ratón y luego se van solos:
tamaño en cuatro pasos, cantidad de tarjetas por pantalla, filtro de *ver solo
lo que falta*, selector de proyecto, pantalla completa y salida. Los ajustes
...
2. SQL Editor → ejecutar en este orden, cada archivo completo y sin nada
   ...
   | `supabase/parche-03-escaneo-automatico.sql` | siempre, al final |
