...
Hay un detalle que conviene entender antes de montarlo así. **El viaje activo
es de cada dispositivo**, no del sistema: se guarda en el navegador. Abrir un
viaje desde la laptop no lo selecciona en el televisor.

Con un solo viaje abierto no hay problema, porque la app lo elige sola en
cualquier dispositivo. Con dos o más, el televisor necesita el suyo, y se
elige en *Ajustes → Cargar en el camión*. Si no hay ninguno seleccionado,
aparece una franja amarilla en la cabecera avisándolo, porque un bulto cargado
sin camión no sale en la guía de despacho de ese viaje.
